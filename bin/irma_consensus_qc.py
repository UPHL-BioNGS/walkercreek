...
def main(consensus_fasta, meta_id):
    ...
    with open(output_tsv, "w", newline="") as f:
        ...
        writer.writerow(["Sample", "IRMA consensus ACTG Count", "IRMA consensus Degenerate Count", "IRMA consensus N Count", "IRMA consensus Total Count", "IRMA consensus Segment Count", "IRMA consensus N50", "IRMA consensus GC Content"])
