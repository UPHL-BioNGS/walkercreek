process QC_REPORT {
    ...
    input:
    tuple val(meta), path(txt), path(results) //input values are from channel that joins FAQCS("txt") output
...
// taken from (https://github.com/CDCgov/mycosnp-nf/blob/master/modules/local/qc_report.nf)
